...
type RulesSearchOption struct {
	...
	F                            string `url:"f,omitempty"`                            // Description:"Comma-separated list of additional fields to be returned in the response. All the fields are returned by default, except actives.",ExampleValue:"createdAt,remFnOverloaded"
