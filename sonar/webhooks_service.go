...
type WebhooksCreateObject struct {
	Webhook WebhooksCreateObject_sub1 `json:"webhook,omitempty"`
}

type WebhooksCreateObject_sub1 struct {
...
type WebhooksDeliveriesObject struct {
	Deliveries []WebhooksDeliveriesObject_sub1 `json:"deliveries,omitempty"`
	Paging     WebhooksDeliveriesObject_sub2   `json:"paging,omitempty"`
}

type WebhooksDeliveriesObject_sub1 struct {
...
type WebhooksDeliveriesObject_sub2 struct {
...
type WebhooksDeliveryObject struct {
	Delivery WebhooksDeliveryObject_sub1 `json:"delivery,omitempty"`
}

type WebhooksDeliveryObject_sub1 struct {
	At           string `json:"at,omitempty"`
	CeTaskID     string `json:"ceTaskId,omitempty"`
	ComponentKey string `json:"componentKey,omitempty"`
	DurationMs   int64  `json:"durationMs,omitempty"`
...
type WebhooksListObject struct {
	Webhooks []WebhooksListObject_sub1 `json:"webhooks,omitempty"`
}
...
type WebhooksUpdateOption struct {
	...
	Secret  string `url:"secret,omitempty"`  // Description:"If provided, secret will be used as the key to generate the HMAC hex (lowercase) digest value in the 'X-Sonar-Webhook-HMAC-SHA256' header. If blank, any secret previously configured will be removed. If not set, the secret will remain unchanged.",ExampleValue:"your_secret"
