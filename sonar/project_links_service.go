...
type ProjectLinksCreateObject struct {
	Link ProjectLinksCreateObject_sub1 `json:"link,omitempty"`
}

type ProjectLinksCreateObject_sub1 struct {
...
type ProjectLinksSearchObject struct {
	Links []ProjectLinksSearchObject_sub1 `json:"links,omitempty"`
}

type ProjectLinksSearchObject_sub1 struct {
	ID   string `json:"id,omitempty"`
	Name string `json:"name,omitempty"`
