...
type RulesCreateObject struct {
	Rule RulesCreateObject_sub3 `json:"rule,omitempty"`
}

type RulesCreateObject_sub3 struct {
	...
	Impacts                    []RulesCreateObject_sub1 `json:"impacts,omitempty"`
	...
	Name                       string                   `json:"name,omitempty"`
	Params                     []RulesCreateObject_sub2 `json:"params,omitempty"`
...
type RulesSearchObject_sub11 struct {
	...
	Impacts                    []RulesSearchObject_sub9  `json:"impacts,omitempty"`
	...
	Params                     []RulesSearchObject_sub10 `json:"params,omitempty"`
	Repo                       string                    `json:"repo,omitempty"`
	Scope                      string                    `json:"scope,omitempty"`
	Severity                   string                    `json:"severity,omitempty"`
	Status                     string                    `json:"status,omitempty"`
...
type RulesShowObject struct {
	...
	Rule    RulesShowObject_sub7   `json:"rule,omitempty"`
}

type RulesShowObject_sub7 struct {
	CleanCodeAttribute         string                 `json:"cleanCodeAttribute,omitempty"`
	CleanCodeAttributeCategory string                 `json:"cleanCodeAttributeCategory,omitempty"`
	...
	HTMLDesc                   string                 `json:"htmlDesc,omitempty"`
	Impacts                    []RulesShowObject_sub5 `json:"impacts,omitempty"`
	InternalKey                string                 `json:"internalKey,omitempty"`
	IsExternal                 bool                   `json:"isExternal,omitempty"`
	Key                        string                 `json:"key,omitempty"`
	Lang                       string                 `json:"lang,omitempty"`
	LangName                   string                 `json:"langName,omitempty"`
	Name                       string                 `json:"name,omitempty"`
	Params                     []RulesShowObject_sub6 `json:"params,omitempty"`
...
type RulesUpdateObject struct {
	Rule RulesUpdateObject_sub3 `json:"rule,omitempty"`
}

type RulesUpdateObject_sub3 struct {
	CleanCodeAttribute         string                   `json:"cleanCodeAttribute,omitempty"`
	CleanCodeAttributeCategory string                   `json:"cleanCodeAttributeCategory,omitempty"`
	CreatedAt                  string                   `json:"createdAt,omitempty"`
	HTMLDesc                   string                   `json:"htmlDesc,omitempty"`
	Impacts                    []RulesUpdateObject_sub1 `json:"impacts,omitempty"`
	IsExternal                 bool                     `json:"isExternal,omitempty"`
	IsTemplate                 bool                     `json:"isTemplate,omitempty"`
	Key                        string                   `json:"key,omitempty"`
	Lang                       string                   `json:"lang,omitempty"`
	...
	MdDesc                     string                   `json:"mdDesc,omitempty"`
	Name                       string                   `json:"name,omitempty"`
	Params                     []RulesUpdateObject_sub2 `json:"params,omitempty"`
	RemFnOverloaded            bool                     `json:"remFnOverloaded,omitempty"`
	Repo                       string                   `json:"repo,omitempty"`
	Scope                      string                   `json:"scope,omitempty"`
	Severity                   string                   `json:"severity,omitempty"`
...
type RulesCreateOption struct {
	CleanCodeAttribute  string `url:"cleanCodeAttribute,omitempty"`  // Description:"Clean code attribute",ExampleValue:""
	CustomKey           string `url:"customKey,omitempty"`           // Description:"Key of the custom rule",ExampleValue:"Todo_should_not_be_used"
	Impacts             string `url:"impacts,omitempty"`             // Description:"Impacts as semi-colon list of &lt;software_quality&gt;=&lt;severity&gt;",ExampleValue:"SECURITY=HIGH;MAINTAINABILITY=LOW"
	...
	Params              string `url:"params,omitempty"`              // Description:"Parameters as semi-colon list of &lt;key&gt;=&lt;value&gt;",ExampleValue:"key1=v1;key2=v2"
	...
	TemplateKey         string `url:"templateKey,omitempty"`         // Description:"Key of the template rule in order to create a custom rule",ExampleValue:"java:XPath"
...
type RulesListOption struct {
	...
	AvailableSince string `url:"available_since,omitempty"` // Description:"Filter rules available since the given date. If no value is provided, all rules are returned. Format is yyyy-MM-dd.",ExampleValue:"2014-06-22"
	P              string `url:"p,omitempty"`               // Description:"1-based page number",ExampleValue:"42"
	Ps             string `url:"ps,omitempty"`              // Description:"Page size. Must be greater than 0 and less than 500",ExampleValue:"20"
	Qprofile       string `url:"qprofile,omitempty"`        // Description:"Filter rules that are activated in the given quality profile.",ExampleValue:""
	S              string `url:"s,omitempty"`               // Description:"Sort field",ExampleValue:""
}

// List List rules, excluding the external rules and the rules with status REMOVED. If a quality profile is provided, it returns only the rules activated in this quality profile. If no quality profile is provided, it returns all the rules available to the user.
...
type RulesSearchOption struct {
	...
	ActiveImpactSeverities       string `url:"active_impactSeverities,omitempty"`      // Description:"Comma-separated list of Activation Software Quality Severities, i.e the impact severity of rules in Quality profiles.",ExampleValue:"HIGH,MEDIUM"
	...
	F                            string `url:"f,omitempty"`                            // Description:"Comma-separated list of additional fields to be returned in the response. All the fields are returned by default, except actives.",ExampleValue:"isTemplate,templateKey"
	...
	P                            string `url:"p,omitempty"`                            // Description:"1-based page number",ExampleValue:"42"
	PrioritizedRule              string `url:"prioritizedRule,omitempty"`              // Description:"Filter on prioritized rules. Ignored if the parameter 'qprofile' is not set.",ExampleValue:""
	Ps                           string `url:"ps,omitempty"`                           // Description:"Page size. Must be greater than 0 and less or equal than 500",ExampleValue:"20"
	Q                            string `url:"q,omitempty"`                            // Description:"UTF-8 search query",ExampleValue:"xpath"
	Qprofile                     string `url:"qprofile,omitempty"`                     // Description:"Quality profile key to filter on. Only rules of the same language as this profile are returned. By default only rules activated in this profile are returned. You can change that using the 'activation' parameter.",ExampleValue:"AU-Tpxb--iU5OvuD2FLy"
...
type RulesUpdateOption struct {
	Impacts                    string `url:"impacts,omitempty"`                       // Description:"Rule impacts, semicolon-separated (Only when updating a custom rule impact severity)",ExampleValue:"MAINTAINABILITY=HIGH;SECURITY=LOW"
	Key                        string `url:"key,omitempty"`                           // Description:"Key of the rule to update",ExampleValue:"javascript:NullCheck"
	MarkdownDescription        string `url:"markdownDescription,omitempty"`           // Description:"Rule description (mandatory for custom rule and manual rule) in <a href='/formatting/help'>markdown format</a>",ExampleValue:"Description of my custom rule"
