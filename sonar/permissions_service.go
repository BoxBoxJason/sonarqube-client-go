...
type PermissionsCreateTemplateObject struct {
	PermissionTemplate PermissionsCreateTemplateObject_sub1 `json:"permissionTemplate,omitempty"`
}

type PermissionsCreateTemplateObject_sub1 struct {
	Description       string `json:"description,omitempty"`
	Name              string `json:"name,omitempty"`
	ProjectKeyPattern string `json:"projectKeyPattern,omitempty"`
}

type PermissionsGroupsObject struct {
	Groups []PermissionsGroupsObject_sub1 `json:"groups,omitempty"`
	Paging PermissionsGroupsObject_sub2   `json:"paging,omitempty"`
}
...
type PermissionsSearchTemplatesObject struct {
	DefaultTemplates    []PermissionsSearchTemplatesObject_sub1 `json:"defaultTemplates,omitempty"`
	PermissionTemplates []PermissionsSearchTemplatesObject_sub3 `json:"permissionTemplates,omitempty"`
}

type PermissionsSearchTemplatesObject_sub3 struct {
	CreatedAt   string                                  `json:"createdAt,omitempty"`
	Description string                                  `json:"description,omitempty"`
	ID          string                                  `json:"id,omitempty"`
	Name        string                                  `json:"name,omitempty"`
	Permissions []PermissionsSearchTemplatesObject_sub2 `json:"permissions,omitempty"`
	UpdatedAt   string                                  `json:"updatedAt,omitempty"`
}

type PermissionsSearchTemplatesObject_sub2 struct {
...
type PermissionsSearchTemplatesObject_sub1 struct {
	Qualifier  string `json:"qualifier,omitempty"`
	TemplateID string `json:"templateId,omitempty"`
}

type PermissionsTemplateGroupsObject struct {
	Groups []PermissionsTemplateGroupsObject_sub1 `json:"groups,omitempty"`
	Paging PermissionsTemplateGroupsObject_sub2   `json:"paging,omitempty"`
}

type PermissionsTemplateGroupsObject_sub1 struct {
	Description string   `json:"description,omitempty"`
	Name        string   `json:"name,omitempty"`
	Permissions []string `json:"permissions,omitempty"`
}

type PermissionsTemplateGroupsObject_sub2 struct {
	PageIndex int64 `json:"pageIndex,omitempty"`
	PageSize  int64 `json:"pageSize,omitempty"`
	Total     int64 `json:"total,omitempty"`
}

type PermissionsTemplateUsersObject struct {
	Paging PermissionsTemplateUsersObject_sub1   `json:"paging,omitempty"`
	Users  []PermissionsTemplateUsersObject_sub2 `json:"users,omitempty"`
}

type PermissionsTemplateUsersObject_sub2 struct {
...
type PermissionsTemplateUsersObject_sub1 struct {
	PageIndex int64 `json:"pageIndex,omitempty"`
	PageSize  int64 `json:"pageSize,omitempty"`
	Total     int64 `json:"total,omitempty"`
}

type PermissionsUpdateTemplateObject struct {
	PermissionTemplate PermissionsUpdateTemplateObject_sub1 `json:"permissionTemplate,omitempty"`
}

type PermissionsUpdateTemplateObject_sub1 struct {
	CreatedAt         string `json:"createdAt,omitempty"`
	Description       string `json:"description,omitempty"`
	ID                string `json:"id,omitempty"`
	Name              string `json:"name,omitempty"`
...
type PermissionsUsersObject struct {
	Paging PermissionsUsersObject_sub1   `json:"paging,omitempty"`
	Users  []PermissionsUsersObject_sub2 `json:"users,omitempty"`
}

type PermissionsUsersObject_sub2 struct {
	Avatar      string   `json:"avatar,omitempty"`
	Email       string   `json:"email,omitempty"`
	Login       string   `json:"login,omitempty"`
	Managed     bool     `json:"managed,omitempty"`
...
type PermissionsUsersObject_sub1 struct {
	PageIndex int64 `json:"pageIndex,omitempty"`
	PageSize  int64 `json:"pageSize,omitempty"`
	Total     int64 `json:"total,omitempty"`
}
...
// Groups Lists the groups with their permissions.<br>This service defaults to global permissions, but can be limited to project permissions by providing project id or project key.<br> This service defaults to all groups, but can be limited to groups with a specific permission by providing the desired permission.<br>Requires one of the following permissions:<ul><li>'Administer System'</li><li>'Administer' rights on the specified project</li></ul>
func (s *PermissionsService) Groups(opt *PermissionsGroupsOption) (v *PermissionsGroupsObject, resp *http.Response, err error) {
...
type PermissionsTemplateGroupsOption struct {
	...
	Permission   string `url:"permission,omitempty"`   // Description:"Permission<ul><li>Possible values for project permissions admin, codeviewer, issueadmin, securityhotspotadmin, scan, user</li></ul>",ExampleValue:""
	Ps           string `url:"ps,omitempty"`           // Description:"Page size. Must be greater than 0 and less or equal than 100",ExampleValue:"20"
	Q            string `url:"q,omitempty"`            // Description:"Limit search to group names that contain the supplied string. <br/>When this parameter is not set, only group having at least one permission are returned.",ExampleValue:"eri"
	TemplateId   string `url:"templateId,omitempty"`   // Description:"Template id",ExampleValue:"AU-Tpxb--iU5OvuD2FLy"
	TemplateName string `url:"templateName,omitempty"` // Description:"Template name",ExampleValue:"Default Permission Template for Projects"
}

// TemplateGroups Lists the groups with their permission as individual groups rather than through user affiliation on the chosen template.<br />This service defaults to all groups, but can be limited to groups with a specific permission by providing the desired permission.<br>Requires the following permission: 'Administer System'.
func (s *PermissionsService) TemplateGroups(opt *PermissionsTemplateGroupsOption) (v *PermissionsTemplateGroupsObject, resp *http.Response, err error) {
	err = s.ValidateTemplateGroupsOpt(opt)
	if err != nil {
		return
	}
	req, err := s.client.NewRequest("GET", "permissions/template_groups", opt)
	if err != nil {
		return
	}
	v = new(PermissionsTemplateGroupsObject)
	resp, err = s.client.Do(req, v)
	if err != nil {
		return nil, resp, err
	}
...
type PermissionsTemplateUsersOption struct {
	...
	Permission   string `url:"permission,omitempty"`   // Description:"Permission<ul><li>Possible values for project permissions admin, codeviewer, issueadmin, securityhotspotadmin, scan, user</li></ul>",ExampleValue:""
	Ps           string `url:"ps,omitempty"`           // Description:"Page size. Must be greater than 0 and less or equal than 100",ExampleValue:"20"
	Q            string `url:"q,omitempty"`            // Description:"Limit search to user names that contain the supplied string. <br/>When this parameter is not set, only users having at least one permission are returned.",ExampleValue:"eri"
	TemplateId   string `url:"templateId,omitempty"`   // Description:"Template id",ExampleValue:"AU-Tpxb--iU5OvuD2FLy"
	TemplateName string `url:"templateName,omitempty"` // Description:"Template name",ExampleValue:"Default Permission Template for Projects"
}

// TemplateUsers Lists the users with their permission as individual users rather than through group affiliation on the chosen template. <br />This service defaults to all users, but can be limited to users with a specific permission by providing the desired permission.<br>Requires the following permission: 'Administer System'.
func (s *PermissionsService) TemplateUsers(opt *PermissionsTemplateUsersOption) (v *PermissionsTemplateUsersObject, resp *http.Response, err error) {
	err = s.ValidateTemplateUsersOpt(opt)
	if err != nil {
		return
	}
	req, err := s.client.NewRequest("GET", "permissions/template_users", opt)
	if err != nil {
		return
	}
	v = new(PermissionsTemplateUsersObject)
	resp, err = s.client.Do(req, v)
	if err != nil {
		return nil, resp, err
	}
...
func (s *PermissionsService) UpdateTemplate(opt *PermissionsUpdateTemplateOption) (v *PermissionsUpdateTemplateObject, resp *http.Response, err error) {
	...
	v = new(PermissionsUpdateTemplateObject)
	resp, err = s.client.Do(req, v)
	if err != nil {
		return nil, resp, err
	}
...
type PermissionsUsersOption struct {
	...
	ProjectKey string `url:"projectKey,omitempty"` // Description:"Project key",ExampleValue:"my_project"
	Ps         string `url:"ps,omitempty"`         // Description:"Page size. Must be greater than 0 and less or equal than 100",ExampleValue:"20"
	Q          string `url:"q,omitempty"`          // Description:"Limit search to user names that contain the supplied string. <br/>",ExampleValue:"eri"
}

// Users Lists the users with their permissions as individual users rather than through group affiliation.<br>This service defaults to global permissions, but can be limited to project permissions by providing project id or project key.<br> This service defaults to all users, but can be limited to users with a specific permission by providing the desired permission.<br>Requires one of the following permissions:<ul><li>'Administer System'</li><li>'Administer' rights on the specified project</li></ul>
