...
var methodDescriptions = map[string]string{ //nolint:gosec // G101 false positive: these are API descriptions, not credentials
	...
	"AlmSettings.DeleteBinding":            "Deletes the DevOps platform binding of a project",
	...
	"AlmSettings.SetAzureBinding":          "Binds an Azure DevOps project to a project",
	"AlmSettings.SetBitbucketBinding":      "Binds a Bitbucket Server project to a project",
	"AlmSettings.SetBitbucketCloudBinding": "Binds a Bitbucket Cloud repository to a project",
	"AlmSettings.SetGithubBinding":         "Binds a GitHub repository to a project",
	"AlmSettings.SetGitlabBinding":         "Binds a GitLab project to a project",
